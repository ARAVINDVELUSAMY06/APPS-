...
static void note(int w){
    ...
    static int availableBalance=20000;
     static int store;
     static int count=1;
     static int w;
     static int mini[];
    static void withdraw(){
        System.out.println("Enter the amount you want to withdraw");
         w=sc.nextInt();
        if(w<availableBalance && w<=a){
         count++;        
         store=w;
         if(bank.equals("Canara")){
           availableBalance=availableBalance-w;
         }
         else{
             availableBalance=(availableBalance-w)-30;
         }
        ...
        if(k.equals("y")){
            ...
            System.out.println("The amount you enter is not available");
        }
        mini=new int[count];
    ...
    static void miniStatement(){
        for(int i=1;i<count;i++){
            ...
            System.out.println(date+" "+mini[i]+" "+availableBalance);  
    ...
    public static void main(String ar[]){
        ...
        break;
            ...
            sc.nextLine();
            bank=sc.next();
        if((name.equals("Aravind"))&&(oldpin==checkPin)){
                t:while(true){
